...
Node* Round_Robin_sub(Queue* ready_queue, int time_step, Node* running_process, STATUS* cpu_status, Gantchart* chart)
{
    ...
    else    // running_process exists
    {
        ...
        else if ( remaining_quantum == 0) // time quantum is over -> go back to ready queue
        {
...
void Priority_nonpreemptive(Queue* ready_queue, Node** pcb_array, int num_process, Gantchart* chart)
{
    ...
    while( complete_process != num_process)
    {
        ...
        print_queue(ready_queue);
        running_process = Priority_nonpreemptive_sub(ready_queue, time_step, running_process, &cpu_status, chart);
...
void SJF_nonpreemptive(Queue* ready_queue, Node** pcb_array, int num_process, Gantchart* chart)
{
    ...
    while( complete_process != num_process)
    {
        ...
        print_queue(ready_queue);
        running_process = SJF_nonpreemptive_sub(ready_queue, time_step, running_process, &cpu_status, chart);
        printf("complete process: %d\n", complete_process);
        time_step++;
    }
}
...
void SJF_preemptive(Queue* ready_queue, Node** pcb_array, int num_process, Gantchart* chart)
{
    ...
    while( complete_process != num_process)
    {
        ...
        print_queue(ready_queue);
        running_process = SJF_preemptive_sub(ready_queue, time_step, running_process, &cpu_status, chart);
        printf("complete process: %d\n", complete_process);
        time_step++;
    }
}
...
void Priority_preemptive(Queue* ready_queue, Node** pcb_array, int num_process, Gantchart* chart)
{
    ...
    while( complete_process != num_process)
    {
        ...
        print_queue(ready_queue);
        running_process = Priority_preemptive_sub(ready_queue, time_step, running_process, &cpu_status, chart);
        printf("complete process: %d\n", complete_process);
        time_step++;
    }
}
...
void Round_Robin(Queue* ready_queue, Node** pcb_array, int num_process, Gantchart* chart)
{
    ...
    while( complete_process != num_process)
    {
        ...
        print_queue(ready_queue);
        running_process = Round_Robin_sub(ready_queue, time_step, running_process, &cpu_status, chart);
        printf("complete process: %d\n", complete_process);
        time_step++;
    }
}